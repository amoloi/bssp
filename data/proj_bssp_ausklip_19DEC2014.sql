...
insert  into `bssp_application_numbers_gen`(`id`,`data`) values (1,NULL);
...
insert  into `bssp_applications`(`id`,`number`,`applicant`,`applicationDate`,`acknowledgementDate`,`createdBy`,`createdOn`,`modifiedBy`,`modifiedOn`) values (1,'BSA20141200000003',4,'2014-12-02','2014-12-03 00:00:00',NULL,'2014-12-07 22:34:40',NULL,NULL),(2,'BSA20141200000002',5,'2014-12-11','0000-00-00 00:00:00',NULL,'2014-12-11 11:26:01',NULL,NULL),(3,'BSA20141200000003',6,'2014-12-02','0000-00-00 00:00:00',NULL,'2014-12-11 11:28:23',NULL,NULL),(4,'BSA20141200000004',7,'2014-12-09','0000-00-00 00:00:00',NULL,'2014-12-11 11:31:21',NULL,NULL),(5,'BSA20141200000005',8,'2014-10-07','0000-00-00 00:00:00',NULL,'2014-12-11 11:33:47',NULL,NULL);
...
insert  into `bssp_master_budgets`(`id`,`code`,`name`,`period`,`amount`,`description`,`GLAccount`,`createdBy`,`createdOn`,`modifiedBy`,`modifiedOn`) values (1,'BSB20132014','BSSP Master Budget 2014 ','2013-2014','45000000','BSSP Master Budget 2014 ',NULL,'SYSTEM','2014-12-07 23:50:48',NULL,NULL);
...
insert  into `bssp_project_budgets`(`id`,`budgetNumber`,`budgetName`,`budgetAmount`,`budgetOutstandingAmount`,`budgetDateOfApproval`,`budgetRemarks`,`masterBudgetNumber`,`projectNumber`,`createdBy`,`createdOn`,`modifiedBy`,`modifiedOn`) values (1,'BSPB20141200000001','Project Budget Name','4500000',NULL,'2014-12-12',NULL,'BSB20132014','BSB20132014',NULL,'2014-12-08 21:49:29',NULL,NULL),(2,'BSPB20141200000002','Project Budget Name New','4500000',NULL,'2014-12-11',NULL,'BSB20132014','BSB20132014',NULL,'2014-12-08 22:06:42',NULL,NULL),(3,'BSPB20141200000003',NULL,NULL,NULL,'2014-12-08',NULL,NULL,NULL,NULL,'2014-12-08 22:06:51',NULL,NULL);
...
insert  into `bssp_project_numbers_gen`(`id`,`year`) values (1,NULL);
...
insert  into `bssp_projects`(`id`,`number`,`name`,`description`,`status`,`discussionDate`,`startDate`,`endDate`,`applicationNumber`,`requestNumber`,`createdBy`,`createdOn`,`modifiedBy`,`modifiedOn`) values (1,'BSP20141200000006','Environment Impact 2016','Environment Impact 2016','NEW',NULL,'2014-12-04','2014-12-05','BSA20141200000003','BSR20141200000019','SYSTEM','2014-12-07 22:50:18',NULL,NULL);
...
insert  into `bssp_requests`(`id`,`requestNumber`,`requestType`,`requestPriotityArea`,`requestBusinessActivity`,`requestStatus`,`requestRemarks`,`applicationNumber`,`createdBy`,`createdOn`,`modifiedBy`,`modifiedOn`) values (1,'BSR20141200000018','Feasibility Studies','Horticulture','Business Activity One','NEW','New Application','BSA20141200000003',NULL,'2014-12-07 22:34:41',NULL,NULL),(2,'BSR20141200000019','Business Plans','Aquaculture','Business Activity Two','APPROVED','Priority Area','BSA20141200000003',NULL,'2014-12-07 22:34:41',NULL,'2014-12-07 22:50:18'),(3,'BSR20141200000020','Mentorship','Joinery and Carpentry','Business Activity Three','APPROVED','Priority Area','BSA20141200000003',NULL,'2014-12-07 22:34:41',NULL,'2014-12-07 22:37:49'),(4,'BSR20141200000001','Training','Chemical','Chemical Reaction','NEW','New Application','BSA20141200000003',NULL,'2014-12-11 11:28:23',NULL,NULL),(5,'BSR20141200000002','Environmental Impact Assessment','Food processing and beverage / drinks products','Impact','NEW','New Application','BSA20141200000005',NULL,'2014-12-11 11:33:47',NULL,NULL);
...
CREATE TABLE `users` (
  ...
  `createdBy` varchar(72) DEFAULT NULL,
  `createdOn` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `modifiedBy` varchar(72) DEFAULT NULL,
  `modifiedOn` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00'
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

/*Data for the table `users` */

insert  into `users`(`id`,`username`,`password`,`id_role`,`ldap`,`firstname`,`lastname`,`email`,`status`,`createdBy`,`createdOn`,`modifiedBy`,`modifiedOn`) values (1,'admin','13956c93ab56025e9397ab69957418989ebab847',3,0,'Administrator','',NULL,1,NULL,'2014-11-11 08:42:28',NULL,'2014-12-08 17:16:35'),(2,'user','ed64662ef2d8425bc7654e5d7a09fee0788b72ec',2,0,'BSSP ','User','info@mti.gov.na',1,NULL,'2014-12-08 17:32:22',NULL,'2014-11-21 14:47:35');
...
/*!50001 CREATE TABLE  `bssp_applications_v`(
 ...
 `acknowledgementDate` varchar(10) ,
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`ausklipc_bssp`@`197.233.6.169` SQL SECURITY DEFINER VIEW `bssp_applications_v` AS select `ba`.`id` AS `applicationId`,`ba`.`number` AS `applicationNumber`,`ba`.`applicant` AS `applicant`,`br`.`id` AS `requestId`,`br`.`requestNumber` AS `requestNumber`,`br`.`requestType` AS `requestType`,`br`.`requestPriotityArea` AS `requestPriotityArea`,`br`.`requestBusinessActivity` AS `requestBusinessActivity`,`br`.`requestStatus` AS `requestStatus`,`br`.`requestRemarks` AS `requestRemarks`,date_format(`ba`.`applicationDate`,'%d/%m/%Y') AS `applicationDate`,date_format(`ba`.`acknowledgementDate`,'%d/%m/%Y') AS `acknowledgementDate`,coalesce(if((concat_ws(' ',`le`.`firstName`,`le`.`middleName`,`le`.`lastName`) = ''),NULL,concat_ws(' ',`le`.`firstName`,`le`.`middleName`,`le`.`lastName`)),if((concat_ws(' ',`le`.`companyName`,`le`.`companyRegistrationNumber`) = ''),NULL,concat_ws(' - ',`le`.`companyName`,`le`.`companyRegistrationNumber`))) AS `applicantName` from ((`bssp_applications` `ba` join `legal_entities` `le` on((`ba`.`applicant` = `le`.`id`))) join `bssp_requests` `br` on((`br`.`applicationNumber` = `ba`.`number`))) order by `ba`.`number` */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`ausklipc_bssp`@`197.233.6.169` SQL SECURITY DEFINER VIEW `bssp_project_budget_lov_v` AS (select `bssp_project_budgets`.`budgetNumber` AS `budgetNumber`,concat_ws(' - ',`bssp_project_budgets`.`budgetName`,`bssp_project_budgets`.`budgetAmount`) AS `budget` from `bssp_project_budgets`) */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`ausklipc_bssp`@`197.233.6.169` SQL SECURITY DEFINER VIEW `city_towns_lov_v` AS (select `ref_cities_towns`.`regionCode` AS `region`,`ref_cities_towns`.`code` AS `value`,`ref_cities_towns`.`name` AS `label` from `ref_cities_towns`) */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`ausklipc_bssp`@`197.233.6.169` SQL SECURITY DEFINER VIEW `constituences_lov_v` AS (select `ref_constituences`.`cityTownCode` AS `town`,`ref_constituences`.`code` AS `value`,`ref_constituences`.`name` AS `label` from `ref_constituences`) */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`ausklipc_bssp`@`197.233.6.169` SQL SECURITY DEFINER VIEW `countries_lov_v` AS (select `country`.`code` AS `code`,`country`.`name` AS `name` from `country`) */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`ausklipc_bssp`@`197.233.6.169` SQL SECURITY DEFINER VIEW `regions_lov_v` AS (select `ref_regions`.`code` AS `value`,`ref_regions`.`name` AS `label` from `ref_regions`) */;
