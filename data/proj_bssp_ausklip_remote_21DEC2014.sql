...
MySQL - 5.5.40-36.1-log : Database - ausklipc_bssptest
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`ausklipc_bssptest` /*!40100 DEFAULT CHARACTER SET latin1 */;

USE `ausklipc_bssptest`;
...
insert  into `address`(`id`,`addressLineOne`,`addressLineTwo`,`postalAddress`,`regionCode`,`cityCode`,`constituencyCode`,`countryCode`,`legalEntityId`,`createdBy`,`createdOn`,`modifiedBy`,`modifiedOn`) values (1,'Komasdal Gladiola','Erf 1117','P.O.Box 50016 Bachbrecht','KHOMAS','WINDHOEK','WINDHOEK EAST','NAM',4,NULL,'2014-12-07 22:34:40',NULL,NULL),(2,'32','23','23','KHOMAS','WINDHOEK','WINDHOEK EAST','NAM',5,NULL,'2014-12-11 11:26:01',NULL,NULL),(3,'32','12','12','KHOMAS','WINDHOEK','WINDHOEK EAST','NAM',6,NULL,'2014-12-11 11:28:23',NULL,NULL),(4,'ss','23','232','KHOMAS','WINDHOEK','WINDHOEK EAST','NAM',7,NULL,'2014-12-11 11:31:21',NULL,NULL),(5,'32333','33223','32323','KHOMAS','WINDHOEK','WINDHOEK EAST','NAM',8,NULL,'2014-12-11 11:33:47',NULL,NULL);
...
insert  into `bssp_address`(`id`,`addressLineOne`,`addressLineTwo`,`postalAddress`,`regionCode`,`cityCode`,`constituencyCode`,`countryCode`,`legalEntityId`,`createdBy`,`createdOn`,`modifiedBy`,`modifiedOn`) values (1,'32','32','3232','KHOMAS','WINDHOEK','WINDHOEK EAST','NAM',1,NULL,'2014-12-19 09:19:35',NULL,NULL),(2,'22','22','22','KHOMAS','WINDHOEK',NULL,'NAM',2,NULL,'2014-12-19 09:22:45',NULL,NULL),(3,'32','32','32','KHOMAS','GROOT AUB','WINDHOEK RURAL','NAM',3,NULL,'2014-12-20 06:11:27',NULL,NULL),(4,'32','23','2323','KHOMAS','WINDHOEK',NULL,'NAM',4,NULL,'2014-12-20 06:13:10',NULL,NULL),(5,'3232','23232','323232','KHOMAS','WINDHOEK',NULL,'NAM',5,NULL,'2014-12-20 06:42:32',NULL,'2014-12-20 06:42:54');
...
insert  into `bssp_applications`(`id`,`applicationNumber`,`applicationDate`,`applicationAcknowledgementDate`,`applicationLegalEntityId`,`applicationLegalEntityType`,`createdBy`,`createdOn`,`modifiedBy`,`modifiedOn`) values (1,'BSA20141200000001','2014-12-30','0000-00-00 00:00:00',1,'company',NULL,'2014-12-19 09:19:35',NULL,NULL),(2,'BSA20141200000002','2014-12-01','0000-00-00 00:00:00',3,'person',NULL,'2014-12-20 06:11:27',NULL,NULL),(3,'BSA20141200000003','2014-12-08','2014-12-20 00:00:00',5,'company',NULL,'2014-12-20 06:42:32',NULL,'2014-12-20 06:42:54');
...
insert  into `bssp_contacts`(`id`,`contactFirstName`,`contactMiddleName`,`contactLastName`,`contactPosition`,`contactTitle`,`legalEntityId`,`createdOn`,`createdBy`,`modifiedBy`,`modifiedOn`) values (1,'Hafeni','H','Ndakunda','MD','Mr',1,'2014-12-19 09:19:35',NULL,NULL,NULL),(2,'Cool','C','Cats','Owner','Reverend',5,'2014-12-20 06:42:32',NULL,NULL,'2014-12-20 06:42:54');
...
insert  into `bssp_legal_entities`(`id`,`firstName`,`middleName`,`lastName`,`dateOfBirth`,`passportNumber`,`identityNumber`,`companyName`,`companyRegistrationNumber`,`entityType`,`entityCategory`,`emailAddress`,`telephoneNumber`,`mobileNumber`,`faxNumber`,`isActive`,`remarks`,`createdOn`,`createdBy`,`modifiedBy`,`modifiedOn`) values (1,NULL,NULL,NULL,NULL,NULL,NULL,'HH Enterprises','cc/1324','company','promoter','hafeni@wadilona.com.na','2356565','6565','6565',1,NULL,'2014-12-19 09:19:35','SYSTEM',NULL,NULL),(2,'Oyenee','J','JJ','2014-07-13','8585','858585',NULL,NULL,'person','consultant','hafeni@wadilona.com.na','22','22','22',1,NULL,'2014-12-19 09:22:45','SYSTEM',NULL,NULL),(3,'JJ','J','Jacksone','1980-08-04','80808','80808080',NULL,NULL,'person','promoter','hafeni@wadilona.com.na','021','021','021',1,NULL,'2014-12-20 06:11:27','SYSTEM',NULL,NULL),(4,'Josua','H','Hidinua','2014-12-15','5252','15252',NULL,NULL,'person','consultant','jhidinua@hotmail.com','525','55','255',1,NULL,'2014-12-20 06:13:10','SYSTEM',NULL,NULL),(5,NULL,NULL,NULL,NULL,NULL,NULL,'Cool Cats','CC/23/23333','company','promoter','hafeni@wadilona.com.na','021','0222','222',1,NULL,'2014-12-20 06:42:32','SYSTEM',NULL,'2014-12-20 06:42:54');
...
insert  into `bssp_master_budgets`(`id`,`code`,`name`,`period`,`amount`,`description`,`GLAccount`,`createdBy`,`createdOn`,`modifiedBy`,`modifiedOn`) values (1,'BSB20142015','2014 -15 MASTER BUDGET','2014-2015','4000000','2014 2015 Budget',NULL,'SYSTEM','2014-12-19 09:23:51',NULL,NULL);
...
insert  into `bssp_project_budgets`(`id`,`budgetNumber`,`budgetName`,`budgetAmount`,`budgetOutstandingAmount`,`budgetDateOfApproval`,`budgetRemarks`,`masterBudgetNumber`,`projectNumber`,`createdBy`,`createdOn`,`modifiedBy`,`modifiedOn`) values (1,'BSPB20141200000009',NULL,'40000',NULL,'2014-12-19',NULL,'BSB20142015','BSP20141200000001',NULL,'2014-12-19 09:25:38',NULL,NULL),(2,'BSPB20141200000010',NULL,'40000',NULL,'2014-12-19',NULL,'BSB20142015','BSP20141200000001',NULL,'2014-12-19 09:25:40',NULL,NULL),(3,'BSPB20141200000011',NULL,'40000',NULL,'2014-12-19',NULL,'BSB20142015','BSP20141200000001',NULL,'2014-12-19 09:27:05',NULL,NULL),(4,'BSPB20141200000012',NULL,'40000',NULL,'2014-12-20',NULL,'BSB20142015','BSP20141200000003',NULL,'2014-12-20 06:19:58',NULL,NULL);
...
insert  into `bssp_project_consultant`(`id`,`legalEntityId`,`projectNumber`,`principleConsultantName`,`MouPsSignedDate`,`consultantId`,`status`,`createdBy`,`createdOn`,`modifiedBy`,`modifiedOn`) values (1,'1','BSP20141200000001','Hafeni','2014-12-19','2','Active',NULL,'2014-12-19 09:25:38',NULL,NULL),(2,'1','BSP20141200000001','Hafeni','2014-12-19','2','Active',NULL,'2014-12-19 09:25:40',NULL,NULL),(3,'1','BSP20141200000001','Hafeni','2014-12-19','2','Active',NULL,'2014-12-19 09:27:05',NULL,NULL),(4,'2','BSP20141200000003','Josua','2014-12-20','4','Active',NULL,'2014-12-20 06:19:58',NULL,NULL);
...
insert  into `bssp_project_implementation`(`id`,`discussionDate`,`dateIssuedToPromoters`,`reportType`,`sourceOfFunds`,`numberOfMaleEmployed`,`numberOfFemaleEmployed`,`implementationRemarks`,`projectNumber`,`createdBy`,`createdOn`,`modifiedBy`,`modifiedOn`) values (1,NULL,'2014-12-19','one','Private',100,120,'Here we go','BSP20141200000001',NULL,'2014-12-19 09:25:38',NULL,NULL),(2,NULL,'2014-12-19','one','Private',100,120,'Here we go','BSP20141200000001',NULL,'2014-12-19 09:25:40',NULL,NULL),(3,NULL,'2014-12-19','one','FNB',100,120,'FNB FUNDED','BSP20141200000001',NULL,'2014-12-19 09:27:05',NULL,NULL),(4,NULL,'2014-12-20','one','FNB FUNDING',3,3,'FNB FUNDED PROJECT','BSP20141200000003',NULL,'2014-12-20 06:19:58',NULL,NULL);
...
insert  into `bssp_project_payment_installments`(`id`,`installmentAmount`,`installmentPhase`,`installmentDateOfPayment`,`installmentBudgetNumber`,`createdBy`,`createdOn`,`modifiedBy`,`modifiedOn`) values (1,'78000','first','2014-12-16','BSPB20141200000005',NULL,'2014-12-18 21:29:58',NULL,NULL),(2,'79000','second','2014-12-15','BSPB20141200000005',NULL,'2014-12-18 21:29:58',NULL,NULL),(3,'7807','third','2014-12-29','BSPB20141200000005',NULL,'2014-12-18 21:29:58',NULL,NULL),(4,'78000','first','2014-12-16','BSPB20141200000006',NULL,'2014-12-18 21:52:25',NULL,NULL),(5,'79000','second','2014-12-15','BSPB20141200000006',NULL,'2014-12-18 21:52:25',NULL,NULL),(6,'7807','third','2014-12-29','BSPB20141200000006',NULL,'2014-12-18 21:52:25',NULL,NULL),(7,'5000','first','2014-12-19','BSPB20141200000009',NULL,'2014-12-19 09:25:38',NULL,NULL),(8,'5000','first','2014-12-19','BSPB20141200000010',NULL,'2014-12-19 09:25:40',NULL,NULL),(9,'5000','first','2014-12-19','BSPB20141200000011',NULL,'2014-12-19 09:27:05',NULL,NULL),(10,'10000','first','2014-12-20','BSPB20141200000012',NULL,'2014-12-20 06:19:58',NULL,NULL);
...
insert  into `bssp_projects`(`id`,`number`,`name`,`description`,`status`,`discussionDate`,`startDate`,`endDate`,`applicationNumber`,`requestNumber`,`createdBy`,`createdOn`,`modifiedBy`,`modifiedOn`) values (1,'BSP20141200000001','ArchitectureProject','Architecture','NEW',NULL,'2014-12-24','2014-12-24','BSA20141200000001','BSR20141200000001','SYSTEM','2014-12-19 09:20:49',NULL,NULL),(2,'BSP20141200000002','Poultry Business','Poultry Business','ACTIVE',NULL,'2014-12-20','2014-12-20','BSA20141200000002','BSR20141200000004','SYSTEM','2014-12-20 06:14:49',NULL,NULL),(3,'BSP20141200000003','Horticulture','Reallly','NEW',NULL,'2014-12-20','2014-12-24','BSA20141200000002','BSR20141200000002','SYSTEM','2014-12-20 06:16:45',NULL,NULL),(4,'BSP20141200000004','Food Processing','Food Processing','ACTIVE',NULL,'2014-12-02','2014-12-05','BSA20141200000003','BSR20141200000005','SYSTEM','2014-12-20 06:55:21',NULL,NULL);
...
insert  into `bssp_requests`(`id`,`requestNumber`,`requestType`,`requestPriotityArea`,`requestBusinessActivity`,`requestStatus`,`requestRemarks`,`applicationNumber`,`createdBy`,`createdOn`,`modifiedBy`,`modifiedOn`) values (1,'BSR20141200000001','Architectural Design','Aquaculture','Architechture','APPROVED','Priority Area','BSA20141200000001',NULL,'2014-12-19 09:19:35',NULL,'2014-12-19 09:20:49'),(2,'BSR20141200000002','Feasibility Studies','Horticulture','Horticulture stuff','APPROVED','Priority Area','BSA20141200000002',NULL,'2014-12-20 06:11:27',NULL,'2014-12-20 06:16:45'),(3,'BSR20141200000003','Training and Mentorship','Chemical','Chemical reations','REJECTED','Not Priority Area','BSA20141200000002',NULL,'2014-12-20 06:11:27',NULL,'2014-12-20 06:16:03'),(4,'BSR20141200000004','Business Plans','Poultry','Want to enter poultry market','APPROVED','Priority Area','BSA20141200000002',NULL,'2014-12-20 06:11:27',NULL,'2014-12-20 06:14:49'),(5,'BSR20141200000005','Training','Food processing and beverage / drinks products','Yes','APPROVED','Priority Area','BSA20141200000003',NULL,'2014-12-20 06:42:32',NULL,'2014-12-20 06:55:21');
...
insert  into `bssp_resolutions`(`id`,`resolutionDiscussionDate`,`resolutionDiscussionStatus`,`resolutionCorespondenceDate`,`resolutionRemarks`,`resolution_requestNumber`,`createdBy`,`createdOn`,`modifiedBy`,`modifiedOn`) values (1,'2014-12-19','APPROVED','2014-12-19','Priority Area','BSR20141200000001',NULL,'2014-12-19 09:20:49',NULL,NULL),(2,'2014-12-20','APPROVED','2014-12-20','Priority Area','BSR20141200000004',NULL,'2014-12-20 06:14:49',NULL,NULL),(3,'2014-12-20','REJECTED','2014-12-20','Not Priority Area','BSR20141200000003',NULL,'2014-12-20 06:16:03',NULL,NULL),(4,'2014-12-20','APPROVED','2014-12-20','Priority Area','BSR20141200000002',NULL,'2014-12-20 06:16:45',NULL,NULL),(5,'2014-12-20','APPROVED','2014-12-20','Priority Area','BSR20141200000005',NULL,'2014-12-20 06:55:21',NULL,NULL);
...
CREATE TABLE `legal_entities` (
  ...
  `businessActivity` varchar(1024) DEFAULT NULL,
  `entityType` varchar(30) DEFAULT NULL COMMENT '[I]ndividual , [C]ompany',
  `entityCategory` varchar(30) DEFAULT NULL COMMENT '[P]romoter , [S]ponsor',
...
insert  into `legal_entities`(`id`,`firstName`,`middleName`,`lastName`,`dateOfBirth`,`passportNumber`,`identityNumber`,`companyName`,`companyRegistrationNumber`,`businessSector`,`businessActivity`,`entityType`,`entityCategory`,`emailAddress`,`telephoneNumber`,`mobileNumber`,`faxNumber`,`isActive`,`remarks`,`createdOn`,`createdBy`,`modifiedBy`,`modifiedOn`) values (1,NULL,NULL,NULL,NULL,NULL,NULL,'Nam Solar Energy','CY/2014/2000',NULL,NULL,'company','promoter','innocent.blacius@gmail.com','+264814774999','+264814774999','+264814774999',1,NULL,'2014-12-07 14:12:38','SYSTEM',NULL,NULL),(2,NULL,NULL,NULL,NULL,NULL,NULL,'AA CUbes International','CY/2014/2054',NULL,NULL,'company','consultant','jadejuliette2000@gmail.com','+264814774999','+264814774999','+264814774999',1,NULL,'2014-12-07 17:09:01','SYSTEM',NULL,NULL),(3,NULL,NULL,NULL,NULL,NULL,NULL,'Ludacen INC 2000','CY/2014/2089',NULL,NULL,'company','promoter','innocent.blacius@gmail.com','+264814774999','+264814774999','+264814774999',1,NULL,'2014-12-07 21:50:40','SYSTEM',NULL,NULL),(4,NULL,NULL,NULL,NULL,NULL,NULL,'Amarion INC','CY/2014/2000',NULL,NULL,'company','promoter','innocent.blacius@gmail.com','+264814774999','+264814774999','+264814774999',1,NULL,'2014-12-07 22:34:40','SYSTEM',NULL,NULL),(5,'Hafeni','N','Ndakunda','1982-07-05','55rf','820808',NULL,NULL,NULL,NULL,'person','promoter','hafeni@mvafund.com.na','061','081','081',1,NULL,'2014-12-11 11:26:00','SYSTEM',NULL,NULL),(6,NULL,NULL,NULL,NULL,NULL,NULL,'MVBBB','cc/123',NULL,NULL,'company','promoter','hafeni@mvafund.com.na','33','33','33',1,NULL,'2014-12-11 11:28:23','SYSTEM',NULL,NULL),(7,'Jackson','JJ','Jakacson','2014-12-09','85','852',NULL,NULL,NULL,NULL,'person','promoter','wadilona@gmail.com','031','032','031',1,NULL,'2014-12-11 11:31:21','SYSTEM',NULL,NULL),(8,NULL,NULL,NULL,NULL,NULL,NULL,'Hafeni CC','CC/123333',NULL,NULL,'company','promoter','hafeni@mvafund.com.na','332332','21541','5454241',1,NULL,'2014-12-11 11:33:47','SYSTEM',NULL,NULL);
...
/*Table structure for table `consultants_v` */

DROP TABLE IF EXISTS `consultants_v`;

/*!50001 DROP VIEW IF EXISTS `consultants_v` */;
/*!50001 DROP TABLE IF EXISTS `consultants_v` */;

/*!50001 CREATE TABLE  `consultants_v`(
 `person` varchar(137) ,
 `company` varchar(289) ,
 `id` bigint(20) unsigned 
)*/;
...
/*Table structure for table `legal_entities_v` */

DROP TABLE IF EXISTS `legal_entities_v`;

/*!50001 DROP VIEW IF EXISTS `legal_entities_v` */;
/*!50001 DROP TABLE IF EXISTS `legal_entities_v` */;

/*!50001 CREATE TABLE  `legal_entities_v`(
 `person` varchar(137) ,
 `company` varchar(289) ,
 `id` bigint(20) unsigned ,
 `entityType` varchar(30) ,
...
/*Table structure for table `promoters_v` */

DROP TABLE IF EXISTS `promoters_v`;

/*!50001 DROP VIEW IF EXISTS `promoters_v` */;
/*!50001 DROP TABLE IF EXISTS `promoters_v` */;

/*!50001 CREATE TABLE  `promoters_v`(
 `person` varchar(137) ,
 `company` varchar(289) ,
 `id` bigint(20) unsigned 
)*/;
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`ausklipc_bssp`@`197.233.195.25` SQL SECURITY DEFINER VIEW `bssp_master_budgets_lov_v` AS (select concat_ws(' : ',`bssp_master_budgets`.`code`,`bssp_master_budgets`.`name`) AS `label`,`bssp_master_budgets`.`code` AS `value` from `bssp_master_budgets` where (`bssp_master_budgets`.`code` is not null)) */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`ausklipc_bssp`@`197.233.195.25` SQL SECURITY DEFINER VIEW `bssp_project_budget_lov_v` AS (select `bssp_project_budgets`.`budgetNumber` AS `budgetNumber`,concat_ws(' - ',`bssp_project_budgets`.`budgetName`,`bssp_project_budgets`.`budgetAmount`) AS `budget` from `bssp_project_budgets`) */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`ausklipc_bssp`@`197.233.195.25` SQL SECURITY DEFINER VIEW `city_towns_lov_v` AS (select `ref_cities_towns`.`regionCode` AS `region`,`ref_cities_towns`.`code` AS `value`,`ref_cities_towns`.`name` AS `label` from `ref_cities_towns`) */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`ausklipc_bssp`@`197.233.195.25` SQL SECURITY DEFINER VIEW `constituences_lov_v` AS (select `ref_constituences`.`cityTownCode` AS `town`,`ref_constituences`.`code` AS `value`,`ref_constituences`.`name` AS `label` from `ref_constituences`) */;

/*View structure for view consultants_v */

/*!50001 DROP TABLE IF EXISTS `consultants_v` */;
/*!50001 DROP VIEW IF EXISTS `consultants_v` */;

/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`ausklipc_bssp`@`197.233.6.169` SQL SECURITY DEFINER VIEW `consultants_v` AS (select concat_ws(' ',`legal_entities`.`firstName`,`legal_entities`.`middleName`,`legal_entities`.`lastName`) AS `person`,concat_ws(' - ',`legal_entities`.`companyName`,`legal_entities`.`companyRegistrationNumber`) AS `company`,`legal_entities`.`id` AS `id` from `legal_entities` where (`legal_entities`.`entityCategory` = 'consultant')) */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`ausklipc_bssp`@`197.233.195.25` SQL SECURITY DEFINER VIEW `countries_lov_v` AS (select `country`.`code` AS `code`,`country`.`name` AS `name` from `country`) */;

/*View structure for view legal_entities_v */

/*!50001 DROP TABLE IF EXISTS `legal_entities_v` */;
/*!50001 DROP VIEW IF EXISTS `legal_entities_v` */;

/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`ausklipc_bssp`@`197.233.6.169` SQL SECURITY DEFINER VIEW `legal_entities_v` AS (select concat_ws(' ',`legal_entities`.`firstName`,`legal_entities`.`middleName`,`legal_entities`.`lastName`) AS `person`,concat_ws(' - ',`legal_entities`.`companyName`,`legal_entities`.`companyRegistrationNumber`) AS `company`,`legal_entities`.`id` AS `id`,`legal_entities`.`entityType` AS `entityType`,`legal_entities`.`entityCategory` AS `entityCategory` from `legal_entities` where (`legal_entities`.`entityCategory` is not null)) */;

/*View structure for view promoters_v */

/*!50001 DROP TABLE IF EXISTS `promoters_v` */;
/*!50001 DROP VIEW IF EXISTS `promoters_v` */;

/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`ausklipc_bssp`@`197.233.6.169` SQL SECURITY DEFINER VIEW `promoters_v` AS (select concat_ws(' ',`legal_entities`.`firstName`,`legal_entities`.`middleName`,`legal_entities`.`lastName`) AS `person`,concat_ws(' - ',`legal_entities`.`companyName`,`legal_entities`.`companyRegistrationNumber`) AS `company`,`legal_entities`.`id` AS `id` from `legal_entities` where (`legal_entities`.`entityCategory` = 'promoter')) */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`ausklipc_bssp`@`197.233.195.25` SQL SECURITY DEFINER VIEW `regions_lov_v` AS (select `ref_regions`.`code` AS `value`,`ref_regions`.`name` AS `label` from `ref_regions`) */;
