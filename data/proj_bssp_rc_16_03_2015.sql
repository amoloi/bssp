...
insert  into `bssp_address`(`id`,`addressLineOne`,`addressLineTwo`,`postalAddress`,`regionCode`,`cityCode`,`constituencyCode`,`countryCode`,`legalEntityId`,`createdBy`,`createdOn`,`modifiedBy`,`modifiedOn`) values (1,'Komasdal Gladiola',NULL,'P.O.Box 50016 Bachbrecht','KHOMAS','DORDABIS','WINDHOEK RURAL','NAM',1,NULL,'2015-03-14 21:38:06',NULL,NULL),(2,'Komasdal Gladiola',NULL,'P.O.Box 50016 Bachbrecht','KHOMAS','WINDHOEK',NULL,'NAM',2,NULL,'2015-03-15 11:18:37',NULL,NULL),(3,'Komasdal Gladiola',NULL,'P.O.Box 50016 Bachbrecht','OSHANA','OSHAKATI','OSHAKATI EAST','NAM',3,NULL,'2015-03-15 14:31:02',NULL,NULL),(4,'Komasdal Gladiola',NULL,'P.O.Box 50016 Bachbrecht','OMAHEKE','BUITEPOS','KALAHARI','NAM',4,NULL,'2015-03-15 17:23:08',NULL,NULL),(5,'Komasdal Gladiola',NULL,NULL,'OSHIKOTO','ONAYENA','ONAYENA','NAM',5,NULL,'2015-03-15 23:34:19',NULL,NULL);
...
insert  into `bssp_applications`(`id`,`applicationNumber`,`applicationDate`,`applicationAcknowledgementDate`,`applicationLegalEntityId`,`applicationLegalEntityType`,`createdBy`,`createdOn`,`modifiedBy`,`modifiedOn`) values (1,'BSA201503140001','2015-03-20','2015-03-27 00:00:00',1,'company','admin','2015-03-14 21:38:06',NULL,NULL),(2,'BSA201503150002','2015-03-12','2015-03-20 00:00:00',3,'company','admin','2015-03-15 14:31:02',NULL,NULL),(3,'BSA201503150003','2015-03-19','2015-03-26 00:00:00',4,'company','admin','2015-03-15 17:23:08',NULL,NULL),(4,'BSA201503150004','2015-03-10','2015-03-18 00:00:00',5,'company','admin','2015-03-15 23:34:19',NULL,NULL);
...
CREATE TABLE `bssp_assignment_extensions` (
  ...
  `assignmentExtensionRemarks` varchar(1200) DEFAULT NULL,
...
insert  into `bssp_assignment_extensions`(`id`,`assignmentExtensionPhase`,`assignmentExtensionDiscussionDate`,`assignmentExtendedFromDate`,`assignmentExtendedToDate`,`assignmentExtensionRemarks`,`assignmentExtensionProjectNumber`,`createdBy`,`createdOn`,`modifiedBy`,`modifiedOn`) values (2,'FIRST PHASE','2015-03-10','2015-03-20','2015-03-20','Project extended to allow for further extension Edited','BSP201503150004','admin','2015-03-15 13:51:24',NULL,NULL);
...
insert  into `bssp_contacts`(`id`,`contactFirstName`,`contactMiddleName`,`contactLastName`,`contactPosition`,`contactTitle`,`legalEntityId`,`createdOn`,`createdBy`,`modifiedBy`,`modifiedOn`) values (1,'William','William','Katongo','General Manager','Dr',1,'2015-03-14 21:38:06',NULL,NULL,NULL),(2,'Gregory','Johan','Kirenga','General Manager','Dr',3,'2015-03-15 14:31:02',NULL,NULL,NULL),(3,'William','Kriez','Katongo','CEO','Dr',4,'2015-03-15 17:23:08',NULL,NULL,NULL),(4,'William','Gregory','Katongo','General Manager','Dr',5,'2015-03-15 23:34:19',NULL,NULL,NULL);
...
insert  into `bssp_legal_entities`(`id`,`firstName`,`middleName`,`lastName`,`dateOfBirth`,`passportNumber`,`identityNumber`,`companyName`,`companyRegistrationNumber`,`entityType`,`entityCategory`,`emailAddress`,`telephoneNumber`,`mobileNumber`,`faxNumber`,`isActive`,`remarks`,`createdOn`,`createdBy`,`modifiedBy`,`modifiedOn`) values (1,NULL,NULL,NULL,NULL,NULL,NULL,'Nam Solar Energy','CY/2014/2089','company','promoter','jadejuliette2000@gmail.com','+264814774999','+264814774999','+264814774999',1,NULL,'2015-03-14 21:38:05','SYSTEM',NULL,NULL),(2,NULL,NULL,NULL,NULL,NULL,NULL,'JADE INFO TECH','CY/2014/2000','company','consultant','jadejuliette2000@gmail.com','+264814774999','+264814774999','+264814774999',1,NULL,'2015-03-15 11:18:37','SYSTEM',NULL,NULL),(3,NULL,NULL,NULL,NULL,NULL,NULL,'Nam Solar Energy','CY/2014/2210','company','promoter','jadejuliette@gmail.com','+264814774999','+264814774999','+264814774999',1,NULL,'2015-03-15 14:31:02','SYSTEM',NULL,NULL),(4,NULL,NULL,NULL,NULL,NULL,NULL,'Amarion INC 2017','CY/2014/2087','company','promoter','jadejuliette2000@gmail.com','+264814774999','+264814774999','+264814774999',1,NULL,'2015-03-15 17:23:07','SYSTEM',NULL,NULL),(5,NULL,NULL,NULL,NULL,NULL,NULL,'Following Trends','CY/2014/2025','company','promoter','jadejuliette@gmail.com','+264814774999','+264814774999','+264814774999',1,NULL,'2015-03-15 23:34:18','SYSTEM',NULL,NULL);
...
insert  into `bssp_master_budgets`(`id`,`code`,`name`,`period`,`amount`,`description`,`GLAccount`,`createdBy`,`createdOn`,`modifiedBy`,`modifiedOn`) values (1,'BSB20152016','BSSP Master Budget 2015-2016','2015-2016','50000000','BSSP Master Budget 2015-2016',NULL,'admin','2015-03-15 11:19:56',NULL,NULL);

/*Table structure for table `bssp_mou` */

DROP TABLE IF EXISTS `bssp_mou`;

CREATE TABLE `bssp_mou` (
...
/*Data for the table `bssp_mou` */

insert  into `bssp_mou`(`id`,`projectNumber`,`signedDate`,`completionDate`,`createdBy`,`createdOn`,`modifiedBy`,`modifiedOn`) values (1,'BSP201503140001','2015-03-26','2015-03-26','admin','2015-03-15 12:14:35','admin','2015-03-15 12:21:06'),(2,'BSP201503150002','2015-03-19','2015-03-25','admin','2015-03-15 12:24:54',NULL,NULL),(3,'BSP201503150003','2015-03-03','2015-03-10','admin','2015-03-15 12:33:11',NULL,NULL),(4,'BSP201503150004','2015-03-20','2015-03-19','admin','2015-03-15 12:48:19','admin','2015-03-16 01:28:14');
...
insert  into `bssp_project_budgets`(`id`,`budgetNumber`,`budgetName`,`budgetAmount`,`budgetOutstandingAmount`,`budgetDateOfApproval`,`budgetRemarks`,`masterBudgetNumber`,`projectNumber`,`createdBy`,`createdOn`,`modifiedBy`,`modifiedOn`) values (1,'BSPB20150315000001',NULL,'10000000',NULL,'2015-03-19',NULL,'BSB20152016','BSP201503140001','admin','2015-03-15 12:14:35','admin','2015-03-15 12:21:06'),(2,'BSPB20150315000002',NULL,'12000000',NULL,'2015-03-10',NULL,'BSB20152016','BSP201503150002','admin','2015-03-15 12:24:54',NULL,NULL),(3,'BSPB20150315000003',NULL,'10000000',NULL,'2015-03-10',NULL,'BSB20152016','BSP201503150003','admin','2015-03-15 12:33:11',NULL,NULL),(4,'BSPB20150315000004',NULL,'10000000',NULL,'2015-03-19',NULL,'BSB20152016','BSP201503150004','admin','2015-03-15 12:48:20','admin','2015-03-16 01:28:14');
...
CREATE TABLE `bssp_project_consultant` (
  ...
  `projectNumber` varchar(20) NOT NULL,
  `principleConsultant` varchar(256) DEFAULT NULL,
...
insert  into `bssp_project_consultant`(`id`,`legalEntityId`,`projectNumber`,`principleConsultant`,`status`,`createdBy`,`createdOn`,`modifiedBy`,`modifiedOn`) values (1,'2','BSP201503140001','Oswald OJ Amolo','Active','admin','2015-03-15 12:14:34','admin','2015-03-15 12:21:06'),(2,'2','BSP201503150002','Gregory J Kirenga','Active','admin','2015-03-15 12:24:54',NULL,NULL),(3,'2','BSP201503150003','Oswald Amolo','Active','admin','2015-03-15 12:33:11',NULL,NULL),(4,'2','BSP201503150004','Oswald OJ Amolo','Active','admin','2015-03-15 12:48:19','admin','2015-03-16 01:28:14');
...
CREATE TABLE `bssp_project_implementation` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `includeImplementationReport` varchar(1) DEFAULT 'N',
...
insert  into `bssp_project_implementation`(`id`,`includeImplementationReport`,`implementationDateOfIssueToPromoters`,`implementationReportType`,`implementationSourceOfFunds`,`implementationRemarks`,`projectNumber`,`createdBy`,`createdOn`,`modifiedBy`,`modifiedOn`) values (1,'Y','2015-03-25','ARCHITECTURAL DESIGN','Jade Fincial Solutions','Jade Fincial Solutions','BSP201503150004','admin','2015-03-15 13:51:24',NULL,NULL),(2,'Y','2015-03-25','ARCHITECTURAL DESIGN','Jade Fincial Solutions','Jade Fincial Solutions','BSP201503150004','admin','2015-03-16 00:28:20',NULL,NULL),(3,'Y','2015-03-25','ARCHITECTURAL DESIGN','Jade Fincial Solutions','Jade Fincial Solutions','BSP201503150004','admin','2015-03-16 01:28:14',NULL,NULL);
...
insert  into `bssp_project_payment_installments`(`id`,`installmentAmount`,`installmentPhase`,`installmentDateOfPayment`,`installmentBudgetNumber`,`createdBy`,`createdOn`,`modifiedBy`,`modifiedOn`) values (1,'5500000','first','2015-03-26','BSPB20150315000004','admin','2015-03-16 00:28:20','admin','2015-03-16 01:28:14'),(2,'2500000','second','2015-03-18','BSPB20150315000004','admin','2015-03-16 01:28:14',NULL,NULL);
...
CREATE TABLE `bssp_projects` (
  ...
  `isDisscussed` varchar(1) NOT NULL DEFAULT 'N',
...
insert  into `bssp_projects`(`id`,`number`,`name`,`description`,`status`,`discussionDate`,`isDisscussed`,`startDate`,`endDate`,`applicationNumber`,`requestNumber`,`createdBy`,`createdOn`,`modifiedBy`,`modifiedOn`) values (1,'BSP201503140001','Joinery and Carpentry 2015','Joinery and Carpentry','NEW','2015-03-15','Y',NULL,NULL,'BSA201503140001','BSR2015300000002','admin','2015-03-14 21:42:50',NULL,NULL),(2,'BSP201503150002','Chiken Farming','Chiken Farming','NEW','2015-03-15','Y',NULL,NULL,'BSA201503140001','BSR2015300000004','admin','2015-03-15 12:22:59',NULL,NULL),(3,'BSP201503150003','Horticulture Business Plan','Horticulture','NEW','2015-03-15','Y',NULL,NULL,'BSA201503140001','BSR2015300000001','admin','2015-03-15 12:31:26',NULL,NULL),(4,'BSP201503150004','Architectural Design','Architectural Design','NEW','2015-03-16','Y',NULL,NULL,'BSA201503140001','BSR2015300000003','admin','2015-03-15 12:35:32',NULL,NULL);
...
CREATE TABLE `bssp_requests` (
  ...
  `otherRequestTypeText` varchar(256) DEFAULT NULL,
  `requestSector` varchar(256) DEFAULT NULL,
  `requestPriotityArea` varchar(1024) DEFAULT NULL,
...
insert  into `bssp_requests`(`id`,`requestNumber`,`requestType`,`otherRequestTypeText`,`requestSector`,`requestPriotityArea`,`requestBusinessActivity`,`requestStatus`,`requestRemarks`,`applicationNumber`,`createdBy`,`createdOn`,`modifiedBy`,`modifiedOn`) values (1,'BSR2015300000001','Business Plan',NULL,'PRI','Horticulture','Business Activity One','APPROVED','Priority Area','BSA201503140001','admin','2015-03-14 21:38:07','admin','2015-03-15 12:31:25'),(2,'BSR2015300000002','Training',NULL,'SEC','Joinery and Carpentry','Business Activity Two','APPROVED','Priority Area','BSA201503140001','admin','2015-03-14 21:38:07','admin','2015-03-14 21:42:50'),(3,'BSR2015300000003','Architectural Design',NULL,'TER','Services','Business Activity Three','APPROVED','Priority Area','BSA201503140001','admin','2015-03-14 21:38:07','admin','2015-03-15 12:35:32'),(4,'BSR2015300000004','Other','Chiken Farming','PRI','Poultry','Business Activity Four- Other','APPROVED','Priority Area','BSA201503140001','admin','2015-03-14 21:38:07','admin','2015-03-15 12:22:59'),(5,'BSR2015300000005','Training',NULL,'PRI','Aquaculture','Business Activity One','PENDING','New Application','BSA201503150002','admin','2015-03-15 14:31:02',NULL,NULL),(6,'BSR2015300000006','Architectural Design',NULL,'SEC','Joinery and Carpentry','Business Activity Two','PENDING','New Application','BSA201503150002','admin','2015-03-15 14:31:03',NULL,NULL),(7,'BSR2015300000007','Training and Mentorship',NULL,'TER','Services','Business Activity Three','PENDING','New Application','BSA201503150002','admin','2015-03-15 14:31:03',NULL,NULL),(8,'BSR2015300000008','Other','Business Activity Four - Not adequetely defined','PRI','Horticulture','Business Activity Four','PENDING','New Application','BSA201503150002','admin','2015-03-15 14:31:03',NULL,NULL),(9,'BSR2015300000009','Business Plan',NULL,'SEC','Building materials','Business Activity One','PENDING','New Application','BSA201503150003','admin','2015-03-15 17:23:08',NULL,NULL),(10,'BSR2015300000010','Environmental Impact Assessment',NULL,'TER','Services','Business Activity Two','PENDING','New Application','BSA201503150003','admin','2015-03-15 17:23:08',NULL,NULL),(11,'BSR2015300000011','Product Development',NULL,'SEC','Food processing and beverage / drinks products','Business Activity Three','PENDING','New Application','BSA201503150003','admin','2015-03-15 17:23:08',NULL,NULL),(12,'BSR2015300000012','Feasibility Study and Business Plan',NULL,'SEC','Cosmetics','Business Activity One','PENDING','New Application','BSA201503150004','admin','2015-03-15 23:34:19',NULL,NULL),(13,'BSR2015300000013','Environmental Impact Assessment',NULL,'SEC','Chemical','Business Activity Two','PENDING','New Application','BSA201503150004','admin','2015-03-15 23:34:19',NULL,NULL);
...
CREATE TABLE `bssp_resolutions` (
  ...
  `resolutionRemarksDescription` text,
...
insert  into `bssp_resolutions`(`id`,`resolutionDiscussionDate`,`resolutionDiscussionStatus`,`resolutionCorespondenceDate`,`resolutionRemarks`,`resolutionRemarksDescription`,`resolution_requestNumber`,`createdBy`,`createdOn`,`modifiedBy`,`modifiedOn`) values (1,'2015-03-14','APPROVED','2015-03-20','Priority Area','Approved Project','BSR2015300000002','admin','2015-03-14 21:42:50',NULL,NULL),(2,'2015-03-19','APPROVED','2015-03-18','Priority Area','Chiken Farming','BSR2015300000004','admin','2015-03-15 12:23:00',NULL,NULL),(3,'2015-03-12','APPROVED','2015-03-27','Priority Area','Horticulture','BSR2015300000001','admin','2015-03-15 12:31:26',NULL,NULL),(4,'2015-03-19','APPROVED','2015-03-26','Priority Area','Architectural Design','BSR2015300000003','admin','2015-03-15 12:35:32',NULL,NULL);
...
/*Table structure for table `ref_priority_areas` */

DROP TABLE IF EXISTS `ref_priority_areas`;

CREATE TABLE `ref_priority_areas` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `code` varchar(128) DEFAULT NULL,
  `name` varchar(256) DEFAULT NULL,
  `isActive` tinyint(1) DEFAULT '1',
  `description` varchar(256) DEFAULT NULL,
  `ref_sector_code` varchar(128) DEFAULT NULL,
  `createdBy` varchar(24) DEFAULT NULL,
  `createdOn` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `modifiedBy` varchar(24) DEFAULT NULL,
  `modifiedOn` timestamp NULL DEFAULT NULL,
...
/*Data for the table `ref_priority_areas` */

insert  into `ref_priority_areas`(`id`,`code`,`name`,`isActive`,`description`,`ref_sector_code`,`createdBy`,`createdOn`,`modifiedBy`,`modifiedOn`) values (1,NULL,'Horticulture',1,'Horticulture','PRI','innocent','2015-02-07 21:59:49',NULL,NULL),(2,NULL,'Aquaculture',1,'Aquaculture','PRI','innocent','2015-02-07 21:59:49',NULL,NULL),(3,NULL,'Poultry',1,'Poultry','PRI','innocent','2015-02-07 21:59:49',NULL,NULL),(4,NULL,'Textile and Garment',1,'Textile and Garment','SEC','innocent','2015-02-07 22:06:35',NULL,NULL),(5,NULL,'Joinery and Carpentry',1,'Joinery and Carpentry','SEC','innocent','2015-02-07 22:06:35',NULL,NULL),(6,NULL,'Leather',1,'Leather','SEC','innocent','2015-02-07 22:06:35',NULL,NULL),(7,NULL,'Food processing and beverage / drinks products',1,'Food processing and beverage / drinks products','SEC','innocent','2015-02-07 22:06:35',NULL,NULL),(8,NULL,'Building materials',1,'Building materials','SEC','innocent','2015-02-07 22:06:35',NULL,NULL),(9,NULL,'Cosmetics',1,'Cosmetics','SEC','innocent','2015-02-07 22:06:35',NULL,NULL),(10,NULL,'Gemstone cutting and polishing',1,'Gemstone cutting and polishing','SEC','innocent','2015-02-07 22:06:35',NULL,NULL),(11,NULL,'Jewellery',1,'Jewellery','SEC','innocent','2015-02-07 22:06:35',NULL,NULL),(12,NULL,'Wood and Charcoal',1,'Wood and Charcoal','SEC','innocent','2015-02-07 22:06:35',NULL,NULL),(13,NULL,'Toilet paper and paper',1,'Toilet paper and paper','SEC','innocent','2015-02-07 22:06:35',NULL,NULL),(14,NULL,'Chemical',1,'Chemical','SEC','innocent','2015-02-07 22:06:35',NULL,NULL),(15,NULL,'Cables',1,'Cables','SEC','innocent','2015-02-07 22:06:35',NULL,NULL),(16,NULL,'Pipes and related products',1,'Pipes and related products','SEC','innocent','2015-02-07 22:06:35',NULL,NULL),(17,NULL,'Services',1,'Services','TER','innocent','2015-02-07 22:16:20',NULL,NULL);
...
/*Table structure for table `ref_sectors` */

DROP TABLE IF EXISTS `ref_sectors`;
...
/*Data for the table `ref_sectors` */

insert  into `ref_sectors`(`id`,`code`,`name`,`isActive`,`description`,`createdBy`,`createdOn`,`modifiedBy`,`modifiedOn`) values (1,'PRI','Primary Sector',1,'Primary Sector','innocent','2015-02-07 21:45:26',NULL,NULL),(2,'SEC','Secondary Sector',1,'Secondary Sector','innocent','2015-02-07 21:45:26',NULL,NULL),(3,'TER','Tertiary Sector',1,'Tertiary Sector','innocent','2015-02-07 21:45:26',NULL,NULL);
...
insert  into `resources`(`id`,`resource`) values (1,'*/*/*'),(3,'home/index/menu'),(2,'home/*/*'),(4,'applications/*/*'),(5,'applications/index/*'),(6,'applications/index/index'),(7,'applications/index/create'),(8,'applications/promoter/*'),(9,'applications/promoter/index'),(10,'applications/promoter/create'),(11,'applications/promoter/update'),(12,'applications/promoter/delete'),(13,'applications/update/*'),(14,'applications/update/index'),(15,'applications/create/*'),(16,'applications/create/index'),(17,'applications/create/delete'),(18,'budgets/*/*'),(19,'budgets/index/*'),(20,'budgets/index/index'),(21,'budgets/index/create'),(22,'budgets/create/*'),(23,'budgets/create/index'),(24,'budgets/create/delete'),(25,'budgets/update/*'),(26,'budgets/update/index'),(27,'commiteeresolutions/*/*'),(28,'commiteeresolutions/index/*'),(29,'commiteeresolutions/index/*'),(30,'commiteeresolutions/index/index'),(31,'commiteeresolutions/commitee-resolutions/*'),(32,'commiteeresolutions/commitee-resolutions/index'),(33,'commiteeresolutions/commitee-resolutions/create'),(34,'commiteeresolutions/commitee-resolutions/resolution-info'),(35,'commiteeresolutions/consultants/*'),(36,'commiteeresolutions/consultants/index'),(37,'commiteeresolutions/consultants/create'),(38,'commiteeresolutions/create/*'),(39,'commiteeresolutions/create/index'),(40,'commiteeresolutions/create/delete'),(41,'commiteeresolutions/details/*'),(42,'commiteeresolutions/details/index'),(43,'commiteeresolutions/payments/*'),(44,'commiteeresolutions/payments/index'),(45,'commiteeresolutions/payments/create'),(46,'commiteeresolutions/update/*'),(47,'commiteeresolutions/update/index'),(48,'consultants/*/*'),(49,'consultants/index/*'),(50,'consultants/index/index'),(51,'consultants/index/create'),(52,'consultants/create/*'),(53,'consultants/create/index'),(54,'consultants/create/delete'),(55,'consultants/update/*'),(56,'consultants/update/index'),(57,'consultants/update/update'),(58,'contacts/*/*'),(59,'contacts/index/*'),(60,'contacts/index/index'),(61,'contacts/update/*'),(62,'contacts/update/index'),(63,'contacts/create/*'),(64,'contacts/create/index'),(65,'contacts/create/delete'),(66,'default/*/*'),(67,'default/index/*'),(68,'default/index/index'),(69,'default/index/login'),(70,'default/update/logout'),(71,'default/error/*'),(72,'default/error/access-denied'),(73,'default/error/authentication-required'),(74,'default/services/*'),(75,'extensions/*/*'),(76,'extensions/index/*'),(77,'extensions/index/index'),(78,'extensions/index/create'),(79,'extensions/create/logout'),(80,'extensions/create/*'),(81,'extensions/create/index'),(82,'extensions/create/delete'),(83,'extensions/update/*'),(84,'extensions/update/index'),(85,'projects/*/*'),(86,'projects/index/*'),(87,'projects/index/index'),(88,'projects/create/*'),(89,'projects/create/index'),(90,'projects/create/delete'),(91,'projects/consultants/*'),(92,'projects/consultants/index'),(93,'projects/consultants/create'),(94,'projects/composition/*'),(95,'projects/composition/index'),(96,'projects/composition/delete'),(97,'projects/commitee-resolutions/*'),(98,'projects/commitee-resolutions/index'),(99,'projects/commitee-resolutions/create'),(100,'projects/commitee-resolutions/resolution-info'),(101,'projects/payments/*'),(102,'projects/payments/index'),(103,'projects/payments/create'),(104,'projects/update/*'),(105,'projects/update/index'),(106,'promoters/*/*'),(107,'promoters/index/*'),(108,'promoters/index/index'),(109,'promoters/details/*'),(110,'promoters/details/index'),(111,'promoters/create/*'),(112,'promoters/create/index'),(113,'promoters/create/delete'),(114,'promoters/create/delete-request'),(115,'promoters/request-details/*'),(116,'promoters/request-details/index'),(117,'promoters/update/*'),(118,'promoters/update/index'),(119,'search/*/*'),(120,'search/index/*'),(121,'search/index/index'),(122,'search/applications/*'),(123,'search/applications/index'),(124,'search/budgets/*'),(125,'search/budgets/index'),(126,'search/commitee-resolutions/*'),(127,'search/commitee-resolutions/index'),(128,'search/consultants/*'),(129,'search/consultants/index'),(130,'search/projects/*'),(131,'search/projects/index'),(132,'users/*/*'),(133,'users/index/*'),(134,'users/index/index'),(135,'users/create/*'),(136,'users/create/index'),(137,'users/create/delete'),(138,'users/update/*'),(139,'users/update/index');
...
CREATE TABLE `roles` (
  ...
  `role_description` varchar(56) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=43 DEFAULT CHARSET=latin1;

/*Data for the table `roles` */

insert  into `roles`(`id`,`role`,`id_parent`,`role_description`) values (1,'admin',0,'Application Administrator'),(3,'user',4,'Application Data Capturer'),(4,'guest',0,'Application Guest User'),(2,'commitee',3,'Application Commitee Resolution');
...
insert  into `users`(`id`,`username`,`password`,`id_role`,`ldap`,`firstname`,`lastname`,`email`,`status`,`createdBy`,`createdOn`,`modifiedBy`,`modifiedOn`) values (1,'admin','32a8ab3f07fdfab5e203542ebc7734cf1efd6edf78bf8b27e1c4ea07c5756ea3',1,0,'BSSP','Administrator','admin@bssp.org',1,NULL,'2014-11-11 08:42:28','admin','2015-02-18 21:52:04'),(3,'bssp','6ab17fbc7a95154b692d9c84cb253ad0989028cb9f8aff828bc9941557d29b1c ',3,0,'BSSP','User','user@bssp.org',1,'SYSTEM','2014-11-11 08:55:11',NULL,'2014-11-11 19:56:32'),(4,'commitee','a34e7c42885f6e10ab3954fe111c8bbefb9eeb01109181acbfa6ac17a7b28b6f',2,0,'BSSP ','Commitee','commitee@bssp.org',1,'SYSTEM','2015-01-04 23:32:29',NULL,NULL),(5,'james','119c9ae6f9ca741bd0a76f87fba0b22cab5413187afb2906aa2875c38e213603',2,0,'James','Julius','james@yahoo.com',1,'SYSTEM','2015-01-05 21:51:00',NULL,NULL);

/*!50106 set global event_scheduler = 1*/;

/* Event structure for event `reset_application_numbers_e` */

/*!50106 DROP EVENT IF EXISTS `reset_application_numbers_e`*/;

DELIMITER $$

/*!50106 CREATE DEFINER=`root`@`localhost` EVENT `reset_application_numbers_e` ON SCHEDULE EVERY 1 DAY STARTS '2015-02-09 00:03:55' ON COMPLETION NOT PRESERVE ENABLE COMMENT 'Reset application numbers to start from 1' DO begin 
					ALTER TABLE bssp_application_numbers_gen AUTO_INCREMENT = 1;
				end */$$
DELIMITER ;
...
/*Table structure for table `bssp_application_count_v` */

DROP TABLE IF EXISTS `bssp_application_count_v`;

/*!50001 DROP VIEW IF EXISTS `bssp_application_count_v` */;
/*!50001 DROP TABLE IF EXISTS `bssp_application_count_v` */;

/*!50001 CREATE TABLE  `bssp_application_count_v`(
 `count` bigint(21) 
)*/;
...
/*!50001 CREATE TABLE  `bssp_applications_legal_entity_v`(
 ...
 `requestPriotityArea` varchar(1024) ,
...
/*!50001 CREATE TABLE  `bssp_applications_v`(
 ...
 `requestNumber` varchar(20) ,
 `requestType` varchar(128) ,
 `otherRequestTypeText` varchar(256) ,
 `requestPriotityArea` varchar(1024) ,
 `requestBusinessActivity` varchar(1024) ,
 `requestStatus` varchar(28) ,
 `requestRemarks` varchar(128) ,
...
/*Table structure for table `bssp_assignment_extensions_v` */

DROP TABLE IF EXISTS `bssp_assignment_extensions_v`;

/*!50001 DROP VIEW IF EXISTS `bssp_assignment_extensions_v` */;
/*!50001 DROP TABLE IF EXISTS `bssp_assignment_extensions_v` */;

/*!50001 CREATE TABLE  `bssp_assignment_extensions_v`(
 `assignmentExtensionId` bigint(20) unsigned ,
 `assignmentExtensionPhase` varchar(30) ,
 `assignmentExtensionDiscussionDate` varchar(10) ,
 `assignmentExtendedFromDate` varchar(10) ,
 `assignmentExtendedToDate` varchar(10) ,
 `assignmentExtensionRemarks` varchar(1200) ,
 `assignmentExtensionProjectNumber` varchar(20) ,
...
/*Table structure for table `bssp_commitee_resolution_count_v` */

DROP TABLE IF EXISTS `bssp_commitee_resolution_count_v`;

/*!50001 DROP VIEW IF EXISTS `bssp_commitee_resolution_count_v` */;
/*!50001 DROP TABLE IF EXISTS `bssp_commitee_resolution_count_v` */;

/*!50001 CREATE TABLE  `bssp_commitee_resolution_count_v`(
 `count` bigint(21) 
)*/;

/*Table structure for table `bssp_consultancy_budget_v` */

DROP TABLE IF EXISTS `bssp_consultancy_budget_v`;

/*!50001 DROP VIEW IF EXISTS `bssp_consultancy_budget_v` */;
/*!50001 DROP TABLE IF EXISTS `bssp_consultancy_budget_v` */;

/*!50001 CREATE TABLE  `bssp_consultancy_budget_v`(
 `consultantLegalEntityId` bigint(20) unsigned ,
 `consultantId` varchar(20) ,
 `committedAmount` varchar(109) ,
 `paidAmount` varchar(109) 
)*/;

/*Table structure for table `bssp_consultancy_payment_draft_v` */

DROP TABLE IF EXISTS `bssp_consultancy_payment_draft_v`;

/*!50001 DROP VIEW IF EXISTS `bssp_consultancy_payment_draft_v` */;
/*!50001 DROP TABLE IF EXISTS `bssp_consultancy_payment_draft_v` */;

/*!50001 CREATE TABLE  `bssp_consultancy_payment_draft_v`(
 `consultantLegalEntityId` bigint(20) unsigned ,
 `firstName` varchar(45) ,
 `middleName` varchar(45) ,
 `lastName` varchar(45) ,
 ...
 `projectConsultancyId` bigint(20) ,
 `consultantId` varchar(20) ,
 `projectNumber` varchar(20) ,
 `principleConsultant` varchar(256) ,
 `committedAmount` decimal(34,0) ,
 `paidAmount` decimal(34,0) 
)*/;

/*Table structure for table `bssp_consultancy_v` */

DROP TABLE IF EXISTS `bssp_consultancy_v`;

/*!50001 DROP VIEW IF EXISTS `bssp_consultancy_v` */;
/*!50001 DROP TABLE IF EXISTS `bssp_consultancy_v` */;

/*!50001 CREATE TABLE  `bssp_consultancy_v`(
 `projectConsultancyId` bigint(20) unsigned ,
 `firstName` varchar(45) ,
 `middleName` varchar(45) ,
 `lastName` varchar(45) ,
 `dateOfBirth` varchar(10) ,
...
/*Table structure for table `bssp_master_budget_v` */

DROP TABLE IF EXISTS `bssp_master_budget_v`;

/*!50001 DROP VIEW IF EXISTS `bssp_master_budget_v` */;
/*!50001 DROP TABLE IF EXISTS `bssp_master_budget_v` */;

/*!50001 CREATE TABLE  `bssp_master_budget_v`(
 `id` bigint(20) unsigned ,
 `code` varchar(20) ,
 `name` varchar(256) ,
 `period` varchar(12) ,
 `masterBudgetAmount` varchar(50) ,
 `committedAmount` varchar(79) ,
 `balanceAmount` varchar(81) 
)*/;
...
/*Table structure for table `bssp_mou_v` */

DROP TABLE IF EXISTS `bssp_mou_v`;

/*!50001 DROP VIEW IF EXISTS `bssp_mou_v` */;
/*!50001 DROP TABLE IF EXISTS `bssp_mou_v` */;

/*!50001 CREATE TABLE  `bssp_mou_v`(
 `mou_id` bigint(20) ,
 `projectNumber` varchar(20) ,
 `signedDate` varchar(10) ,
 `completionDate` varchar(10) 
)*/;

/*Table structure for table `bssp_payment_installments` */

DROP TABLE IF EXISTS `bssp_payment_installments`;

/*!50001 DROP VIEW IF EXISTS `bssp_payment_installments` */;
/*!50001 DROP TABLE IF EXISTS `bssp_payment_installments` */;

/*!50001 CREATE TABLE  `bssp_payment_installments`(
 `id` bigint(20) unsigned ,
 `installmentAmount` decimal(12,0) ,
 `installmentPhase` varchar(30) ,
 `installmentDateOfPayment` varchar(10) ,
 `installmentBudgetNumber` varchar(20) 
)*/;

/*Table structure for table `bssp_payment_installments_v` */

DROP TABLE IF EXISTS `bssp_payment_installments_v`;

/*!50001 DROP VIEW IF EXISTS `bssp_payment_installments_v` */;
/*!50001 DROP TABLE IF EXISTS `bssp_payment_installments_v` */;

/*!50001 CREATE TABLE  `bssp_payment_installments_v`(
 `installmentId` bigint(20) unsigned ,
 `installmentAmount` decimal(12,0) ,
 `phase` varchar(30) ,
 `installmentDateOfPayment` varchar(10) ,
 `installmentBudgetNumber` varchar(20) 
...
/*Table structure for table `bssp_priority_arears_v` */

DROP TABLE IF EXISTS `bssp_priority_arears_v`;

/*!50001 DROP VIEW IF EXISTS `bssp_priority_arears_v` */;
/*!50001 DROP TABLE IF EXISTS `bssp_priority_arears_v` */;

/*!50001 CREATE TABLE  `bssp_priority_arears_v`(
 `value` varchar(256) ,
 `label` varchar(256) ,
 `ref_sector_code` varchar(128) 
)*/;
...
/*!50001 CREATE TABLE  `bssp_project_budget_details_v`(
 ...
 `paidAmount` varchar(79) ,
 `autstandingAmount` varchar(81) ,
 `projectNumber` varchar(20) ,
...
/*Table structure for table `bssp_project_budget_v` */

DROP TABLE IF EXISTS `bssp_project_budget_v`;

/*!50001 DROP VIEW IF EXISTS `bssp_project_budget_v` */;
/*!50001 DROP TABLE IF EXISTS `bssp_project_budget_v` */;

/*!50001 CREATE TABLE  `bssp_project_budget_v`(
 `projectBudgetId` bigint(20) unsigned ,
 `budgetNumber` varchar(20) ,
 `budgetName` varchar(120) ,
 `budgetAmount` decimal(12,0) ,
 `budgetOutstandingAmount` decimal(12,0) ,
 `budgetDateOfApproval` varchar(10) ,
 `masterBudgetNumber` varchar(20) ,
 `projectNumber` varchar(20) ,
 `masterBudgetId` bigint(20) unsigned ,
 `code` varchar(20) ,
 `name` varchar(256) ,
 `period` varchar(12) ,
 `amount` decimal(12,0) 
...
/*Table structure for table `bssp_project_consultancy_v` */

DROP TABLE IF EXISTS `bssp_project_consultancy_v`;

/*!50001 DROP VIEW IF EXISTS `bssp_project_consultancy_v` */;
/*!50001 DROP TABLE IF EXISTS `bssp_project_consultancy_v` */;

/*!50001 CREATE TABLE  `bssp_project_consultancy_v`(
 `consultantLegalEntityId` bigint(20) unsigned ,
 `firstName` varchar(45) ,
 `middleName` varchar(45) ,
 `lastName` varchar(45) ,
...
/*!50001 CREATE TABLE  `bssp_project_implementation_v`(
 ...
 `includeImplementationReport` varchar(1) ,
...
/*Table structure for table `bssp_projects_count_v` */

DROP TABLE IF EXISTS `bssp_projects_count_v`;

/*!50001 DROP VIEW IF EXISTS `bssp_projects_count_v` */;
/*!50001 DROP TABLE IF EXISTS `bssp_projects_count_v` */;

/*!50001 CREATE TABLE  `bssp_projects_count_v`(
 `count` bigint(21) 
)*/;
...
/*!50001 CREATE TABLE  `bssp_projects_v`(
 ...
 `applicationNumber` varchar(20) ,
 `requestNumber` varchar(20) ,
 `isDisscussed` varchar(1) ,
 `discussionDate` varchar(10) 
)*/;
...
/*!50001 CREATE TABLE  `bssp_requests_projects_v`(
 ...
 `requestNumber` varchar(20) ,
 `requestType` varchar(128) ,
 `requestSector` varchar(256) ,
 `requestPriotityArea` text ,
 `requestBusinessActivity` varchar(1024) ,
 `requestStatus` varchar(28) ,
 `requestRemarks` varchar(128) ,
 `applicationNumber` varchar(20) ,
...
/*Table structure for table `bssp_sectors_v` */

DROP TABLE IF EXISTS `bssp_sectors_v`;

/*!50001 DROP VIEW IF EXISTS `bssp_sectors_v` */;
/*!50001 DROP TABLE IF EXISTS `bssp_sectors_v` */;

/*!50001 CREATE TABLE  `bssp_sectors_v`(
 `value` varchar(128) ,
 `label` varchar(128) 
)*/;
...
/*View structure for view bssp_application_count_v */

/*!50001 DROP TABLE IF EXISTS `bssp_application_count_v` */;
/*!50001 DROP VIEW IF EXISTS `bssp_application_count_v` */;

/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `bssp_application_count_v` AS select count(distinct `a`.`applicationNumber`) AS `count` from (`bssp_applications_v` `a` join `bssp_requests_v` `r` on((`a`.`applicationNumber` = `r`.`applicationNumber`))) where (`r`.`requestStatus` = 'PENDING') */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `bssp_applications_v` AS select `ba`.`id` AS `applicationId`,`ba`.`applicationNumber` AS `applicationNumber`,date_format(`ba`.`applicationDate`,'%d/%m/%Y') AS `applicationDate`,date_format(`ba`.`applicationAcknowledgementDate`,'%d/%m/%Y') AS `applicationAcknowledgementDate`,`ba`.`applicationLegalEntityId` AS `applicationLegalEntityId`,`br`.`id` AS `requestId`,`br`.`requestNumber` AS `requestNumber`,`br`.`requestType` AS `requestType`,`br`.`otherRequestTypeText` AS `otherRequestTypeText`,`br`.`requestPriotityArea` AS `requestPriotityArea`,`br`.`requestBusinessActivity` AS `requestBusinessActivity`,`br`.`requestStatus` AS `requestStatus`,`br`.`requestRemarks` AS `requestRemarks`,`le`.`firstName` AS `firstName`,`le`.`middleName` AS `middleName`,`le`.`lastName` AS `lastName`,date_format(`le`.`dateOfBirth`,'%d/%m/%Y') AS `dateOfBirth`,`le`.`passportNumber` AS `passportNumber`,`le`.`identityNumber` AS `identityNumber`,`le`.`companyName` AS `companyName`,`le`.`companyRegistrationNumber` AS `companyRegistrationNumber`,coalesce(if((concat_ws(' ',`le`.`firstName`,`le`.`middleName`,`le`.`lastName`) = ''),NULL,concat_ws(' ',`le`.`firstName`,`le`.`middleName`,`le`.`lastName`)),if((concat_ws(' ',`le`.`companyName`,`le`.`companyRegistrationNumber`) = ''),NULL,concat_ws(' - ',`le`.`companyName`,`le`.`companyRegistrationNumber`))) AS `applicantName`,`le`.`entityType` AS `entityType`,`le`.`emailAddress` AS `emailAddress`,`le`.`telephoneNumber` AS `telephoneNumber`,`le`.`mobileNumber` AS `mobileNumber`,`le`.`faxNumber` AS `faxNumber` from ((`bssp_applications` `ba` join `bssp_legal_entities` `le` on((`ba`.`applicationLegalEntityId` = `le`.`id`))) join `bssp_requests` `br` on((`br`.`applicationNumber` = `ba`.`applicationNumber`))) order by `ba`.`applicationNumber` */;

/*View structure for view bssp_assignment_extensions_v */

/*!50001 DROP TABLE IF EXISTS `bssp_assignment_extensions_v` */;
/*!50001 DROP VIEW IF EXISTS `bssp_assignment_extensions_v` */;

/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `bssp_assignment_extensions_v` AS select `bssp_assignment_extensions`.`id` AS `assignmentExtensionId`,`bssp_assignment_extensions`.`assignmentExtensionPhase` AS `assignmentExtensionPhase`,date_format(`bssp_assignment_extensions`.`assignmentExtensionDiscussionDate`,'%d/%m/%Y') AS `assignmentExtensionDiscussionDate`,date_format(`bssp_assignment_extensions`.`assignmentExtendedFromDate`,'%d/%m/%Y') AS `assignmentExtendedFromDate`,date_format(`bssp_assignment_extensions`.`assignmentExtendedToDate`,'%d/%m/%Y') AS `assignmentExtendedToDate`,`bssp_assignment_extensions`.`assignmentExtensionRemarks` AS `assignmentExtensionRemarks`,`bssp_assignment_extensions`.`assignmentExtensionProjectNumber` AS `assignmentExtensionProjectNumber`,`bssp_assignment_extensions`.`createdBy` AS `createdBy`,`bssp_assignment_extensions`.`createdOn` AS `createdOn`,`bssp_assignment_extensions`.`modifiedBy` AS `modifiedBy`,`bssp_assignment_extensions`.`modifiedOn` AS `modifiedOn` from `bssp_assignment_extensions` */;

/*View structure for view bssp_commitee_resolution_count_v */

/*!50001 DROP TABLE IF EXISTS `bssp_commitee_resolution_count_v` */;
/*!50001 DROP VIEW IF EXISTS `bssp_commitee_resolution_count_v` */;

/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `bssp_commitee_resolution_count_v` AS select count(distinct `r`.`requestNumber`) AS `count` from `bssp_requests_v` `r` where (`r`.`requestStatus` = 'PENDING') */;

/*View structure for view bssp_consultancy_budget_v */

/*!50001 DROP TABLE IF EXISTS `bssp_consultancy_budget_v` */;
/*!50001 DROP VIEW IF EXISTS `bssp_consultancy_budget_v` */;

/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `bssp_consultancy_budget_v` AS select `bssp_consultancy_payment_draft_v`.`consultantLegalEntityId` AS `consultantLegalEntityId`,`bssp_consultancy_payment_draft_v`.`consultantId` AS `consultantId`,format(coalesce(sum(`bssp_consultancy_payment_draft_v`.`committedAmount`),0),2) AS `committedAmount`,format(coalesce(sum(`bssp_consultancy_payment_draft_v`.`paidAmount`),0),2) AS `paidAmount` from `bssp_consultancy_payment_draft_v` */;

/*View structure for view bssp_consultancy_payment_draft_v */

/*!50001 DROP TABLE IF EXISTS `bssp_consultancy_payment_draft_v` */;
/*!50001 DROP VIEW IF EXISTS `bssp_consultancy_payment_draft_v` */;

/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `bssp_consultancy_payment_draft_v` AS select `le`.`id` AS `consultantLegalEntityId`,`le`.`firstName` AS `firstName`,`le`.`middleName` AS `middleName`,`le`.`lastName` AS `lastName`,date_format(`le`.`dateOfBirth`,'%d/%m/%Y') AS `dateOfBirth`,`le`.`passportNumber` AS `passportNumber`,`le`.`identityNumber` AS `identityNumber`,`le`.`companyName` AS `companyName`,`le`.`companyRegistrationNumber` AS `companyRegistrationNumber`,`le`.`entityType` AS `entityType`,`le`.`entityCategory` AS `entityCategory`,`pc`.`id` AS `projectConsultancyId`,`pc`.`legalEntityId` AS `consultantId`,`pc`.`projectNumber` AS `projectNumber`,`pc`.`principleConsultant` AS `principleConsultant`,(select coalesce(sum(`bssp_project_budgets`.`budgetAmount`),0) from `bssp_project_budgets` where (`bssp_project_budgets`.`projectNumber` = `pc`.`projectNumber`)) AS `committedAmount`,(select coalesce(sum(`bssp_project_payment_installments`.`installmentAmount`),0) from (`bssp_project_payment_installments` join `bssp_project_budgets` on((`bssp_project_payment_installments`.`installmentBudgetNumber` = `bssp_project_budgets`.`budgetNumber`))) where (`bssp_project_budgets`.`projectNumber` = `pc`.`projectNumber`)) AS `paidAmount` from (`bssp_legal_entities` `le` join `bssp_project_consultant` `pc` on((`le`.`id` = `pc`.`legalEntityId`))) where (`le`.`entityCategory` = 'consultant') */;

/*View structure for view bssp_consultancy_v */

/*!50001 DROP TABLE IF EXISTS `bssp_consultancy_v` */;
/*!50001 DROP VIEW IF EXISTS `bssp_consultancy_v` */;

/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `bssp_consultancy_v` AS select `bssp_legal_entities`.`id` AS `projectConsultancyId`,`bssp_legal_entities`.`firstName` AS `firstName`,`bssp_legal_entities`.`middleName` AS `middleName`,`bssp_legal_entities`.`lastName` AS `lastName`,date_format(`bssp_legal_entities`.`dateOfBirth`,'%d/%m/%Y') AS `dateOfBirth`,`bssp_legal_entities`.`passportNumber` AS `passportNumber`,`bssp_legal_entities`.`identityNumber` AS `identityNumber`,`bssp_legal_entities`.`companyName` AS `companyName`,`bssp_legal_entities`.`companyRegistrationNumber` AS `companyRegistrationNumber`,`bssp_legal_entities`.`entityType` AS `entityType`,`bssp_legal_entities`.`entityCategory` AS `entityCategory`,`bssp_legal_entities`.`emailAddress` AS `emailAddress`,`bssp_legal_entities`.`telephoneNumber` AS `telephoneNumber`,`bssp_legal_entities`.`mobileNumber` AS `mobileNumber`,`bssp_legal_entities`.`faxNumber` AS `faxNumber`,`bssp_legal_entities`.`isActive` AS `isActive`,`bssp_legal_entities`.`remarks` AS `remarks` from `bssp_legal_entities` where (`bssp_legal_entities`.`entityCategory` = 'consultant') order by `bssp_legal_entities`.`createdOn` */;
...
/*View structure for view bssp_master_budget_v */

/*!50001 DROP TABLE IF EXISTS `bssp_master_budget_v` */;
/*!50001 DROP VIEW IF EXISTS `bssp_master_budget_v` */;

/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `bssp_master_budget_v` AS select `bssp_master_budgets`.`id` AS `id`,`bssp_master_budgets`.`code` AS `code`,`bssp_master_budgets`.`name` AS `name`,`bssp_master_budgets`.`period` AS `period`,format(coalesce(`bssp_master_budgets`.`amount`,0),2) AS `masterBudgetAmount`,format((select coalesce(sum(`bssp_project_budgets`.`budgetAmount`),0) from `bssp_project_budgets` where (`bssp_project_budgets`.`masterBudgetNumber` = `bssp_master_budgets`.`code`)),2) AS `committedAmount`,format((coalesce(`bssp_master_budgets`.`amount`,0) - (select coalesce(sum(`bssp_project_budgets`.`budgetAmount`),0) from `bssp_project_budgets` where (`bssp_project_budgets`.`masterBudgetNumber` = `bssp_master_budgets`.`code`))),2) AS `balanceAmount` from `bssp_master_budgets` */;
...
/*View structure for view bssp_mou_v */

/*!50001 DROP TABLE IF EXISTS `bssp_mou_v` */;
/*!50001 DROP VIEW IF EXISTS `bssp_mou_v` */;

/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `bssp_mou_v` AS select `bssp_mou`.`id` AS `mou_id`,`bssp_mou`.`projectNumber` AS `projectNumber`,date_format(`bssp_mou`.`signedDate`,'%d/%m/%Y') AS `signedDate`,date_format(`bssp_mou`.`completionDate`,'%d/%m/%Y') AS `completionDate` from `bssp_mou` order by date_format(`bssp_mou`.`signedDate`,'%d/%m/%Y') desc */;

/*View structure for view bssp_payment_installments */

/*!50001 DROP TABLE IF EXISTS `bssp_payment_installments` */;
/*!50001 DROP VIEW IF EXISTS `bssp_payment_installments` */;

/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `bssp_payment_installments` AS select `bssp_project_payment_installments`.`id` AS `id`,`bssp_project_payment_installments`.`installmentAmount` AS `installmentAmount`,`bssp_project_payment_installments`.`installmentPhase` AS `installmentPhase`,date_format(`bssp_project_payment_installments`.`installmentDateOfPayment`,'%d/%m/%Y') AS `installmentDateOfPayment`,`bssp_project_payment_installments`.`installmentBudgetNumber` AS `installmentBudgetNumber` from `bssp_project_payment_installments` */;

/*View structure for view bssp_payment_installments_v */

/*!50001 DROP TABLE IF EXISTS `bssp_payment_installments_v` */;
/*!50001 DROP VIEW IF EXISTS `bssp_payment_installments_v` */;

/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `bssp_payment_installments_v` AS select `bssp_project_payment_installments`.`id` AS `installmentId`,`bssp_project_payment_installments`.`installmentAmount` AS `installmentAmount`,`bssp_project_payment_installments`.`installmentPhase` AS `phase`,date_format(`bssp_project_payment_installments`.`installmentDateOfPayment`,'%d/%m/%Y') AS `installmentDateOfPayment`,`bssp_project_payment_installments`.`installmentBudgetNumber` AS `installmentBudgetNumber` from `bssp_project_payment_installments` */;

/*View structure for view bssp_priority_arears_v */

/*!50001 DROP TABLE IF EXISTS `bssp_priority_arears_v` */;
/*!50001 DROP VIEW IF EXISTS `bssp_priority_arears_v` */;

/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `bssp_priority_arears_v` AS (select `ref_priority_areas`.`name` AS `value`,`ref_priority_areas`.`description` AS `label`,`ref_priority_areas`.`ref_sector_code` AS `ref_sector_code` from `ref_priority_areas` order by `ref_priority_areas`.`name`) */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `bssp_project_budget_details_v` AS select `bssp_project_budgets`.`budgetNumber` AS `budgetNumber`,format(`bssp_project_budgets`.`budgetAmount`,2) AS `budgetAmount`,format((select sum(`bssp_project_payment_installments`.`installmentAmount`) from `bssp_project_payment_installments` where (`bssp_project_payment_installments`.`installmentBudgetNumber` = `bssp_project_budgets`.`budgetNumber`)),2) AS `paidAmount`,format((`bssp_project_budgets`.`budgetAmount` - (select sum(`bssp_project_payment_installments`.`installmentAmount`) from `bssp_project_payment_installments` where (`bssp_project_payment_installments`.`installmentBudgetNumber` = `bssp_project_budgets`.`budgetNumber`))),2) AS `autstandingAmount`,`bssp_project_budgets`.`projectNumber` AS `projectNumber`,`bssp_project_budgets`.`masterBudgetNumber` AS `masterBudgetNumber` from (`bssp_project_budgets` join `bssp_project_payment_installments` on((`bssp_project_budgets`.`budgetNumber` = `bssp_project_payment_installments`.`installmentBudgetNumber`))) group by `bssp_project_budgets`.`projectNumber` */;
...
/*View structure for view bssp_project_budget_v */

/*!50001 DROP TABLE IF EXISTS `bssp_project_budget_v` */;
/*!50001 DROP VIEW IF EXISTS `bssp_project_budget_v` */;

/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `bssp_project_budget_v` AS select `pb`.`id` AS `projectBudgetId`,`pb`.`budgetNumber` AS `budgetNumber`,`pb`.`budgetName` AS `budgetName`,`pb`.`budgetAmount` AS `budgetAmount`,`pb`.`budgetOutstandingAmount` AS `budgetOutstandingAmount`,date_format(`pb`.`budgetDateOfApproval`,'%d/%m/%Y') AS `budgetDateOfApproval`,`pb`.`masterBudgetNumber` AS `masterBudgetNumber`,`pb`.`projectNumber` AS `projectNumber`,`mb`.`id` AS `masterBudgetId`,`mb`.`code` AS `code`,`mb`.`name` AS `name`,`mb`.`period` AS `period`,`mb`.`amount` AS `amount` from (`bssp_project_budgets` `pb` join `bssp_master_budgets` `mb` on((`pb`.`masterBudgetNumber` = `mb`.`code`))) */;

/*View structure for view bssp_project_consultancy_v */

/*!50001 DROP TABLE IF EXISTS `bssp_project_consultancy_v` */;
/*!50001 DROP VIEW IF EXISTS `bssp_project_consultancy_v` */;

/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `bssp_project_consultancy_v` AS select `le`.`id` AS `consultantLegalEntityId`,`le`.`firstName` AS `firstName`,`le`.`middleName` AS `middleName`,`le`.`lastName` AS `lastName`,date_format(`le`.`dateOfBirth`,'%d/%m/%Y') AS `dateOfBirth`,`le`.`passportNumber` AS `passportNumber`,`le`.`identityNumber` AS `identityNumber`,`le`.`companyName` AS `companyName`,`le`.`companyRegistrationNumber` AS `companyRegistrationNumber`,`le`.`entityType` AS `entityType`,`le`.`entityCategory` AS `entityCategory`,`le`.`emailAddress` AS `emailAddress`,`le`.`telephoneNumber` AS `telephoneNumber`,`le`.`mobileNumber` AS `mobileNumber`,`le`.`faxNumber` AS `faxNumber`,`le`.`isActive` AS `isActive`,`le`.`remarks` AS `remarks`,`pc`.`id` AS `projectConsultancyId`,`pc`.`legalEntityId` AS `consultantId`,`pc`.`projectNumber` AS `projectNumber`,`pc`.`principleConsultant` AS `principleConsultant` from (`bssp_legal_entities` `le` join `bssp_project_consultant` `pc` on((`le`.`id` = `pc`.`legalEntityId`))) where (`le`.`entityCategory` = 'consultant') order by `le`.`createdOn` */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `bssp_projects_v` AS select `bssp_projects`.`id` AS `id`,`bssp_projects`.`number` AS `number`,ucase(`bssp_projects`.`name`) AS `name`,`bssp_projects`.`description` AS `description`,`bssp_projects`.`status` AS `status`,date_format(`bssp_projects`.`startDate`,'%d/%m/%Y') AS `startDate`,date_format(`bssp_projects`.`endDate`,'%d/%m/%Y') AS `endDate`,`bssp_projects`.`applicationNumber` AS `applicationNumber`,`bssp_projects`.`requestNumber` AS `requestNumber`,`bssp_projects`.`isDisscussed` AS `isDisscussed`,date_format(`bssp_projects`.`discussionDate`,'%d/%m/%Y') AS `discussionDate` from `bssp_projects` order by `bssp_projects`.`number` desc */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `bssp_requests_v` AS (select `bssp_requests`.`id` AS `requestId`,`bssp_requests`.`requestNumber` AS `requestNumber`,`bssp_requests`.`requestType` AS `requestType`,`bssp_requests`.`otherRequestTypeText` AS `otherRequestTypeText`,`bssp_requests`.`requestSector` AS `requestSector`,`bssp_requests`.`requestPriotityArea` AS `requestPriotityArea`,`bssp_requests`.`requestBusinessActivity` AS `requestBusinessActivity`,`bssp_requests`.`requestStatus` AS `requestStatus`,`bssp_requests`.`requestRemarks` AS `requestRemarks`,`bssp_requests`.`applicationNumber` AS `applicationNumber` from `bssp_requests`) */;
